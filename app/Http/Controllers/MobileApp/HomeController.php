...
class HomeController extends Controller
{
    ...
    public function index1()
    {
        ...
        return response()->json([
            'status' => 'success',
            'homeData' => $this->homeData(auth()->user()->id),
        ]);
    }
    public function index()
    {
        ...
        return response()->json(['status'=>'success','banner' => $banner, 'latestProducts' => $this->setupLatestProducts($latestProducts), 'brands' => $brands, 'popularCategories' => $popularCategories]);
    }
