...
var KTDatatablesServerSide = (function () {
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios
                            .get(BASE_URL + "/categories/" + id + "/edit")
                            .then(function (response) {
                                console.log(response.data);
                                setupEditModal(response.data.category);
                            })
                            .catch(function (error) {})
                            .finally(function () {});
                    },
    ...
    var setupEditModal = (category) => {
        form.category_name.value = category.category_name;
        let category_image = "/assets/media/svg/files/blank-image.svg";
        if (category.category_image) {
            category_image = BASE_URL + "/storage/" + category.category_image;
        }
        form.querySelector("#category_img").style.backgroundImage =
            "url(" + category_image + ")";
        ...
        form.action = BASE_URL + "/categories/" + category.id;
        modal.show();
    };
    ...
    (i = document.querySelector("#CategoryModal")) &&
        ...
        document.getElementById('category-modal-button').addEventListener('click', function () {
            ...
            form.setAttribute("action", BASE_URL + '/categories');
            modal.show()
        });
