...
var KTDatatablesServerSide = (function () {
        ...
        deleteButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios
                            .delete(BASE_URL + "/checkoutpayments/" + id)
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios
                            .get(BASE_URL + "/checkoutpayments/" + id + "/edit")
                            .then(function (response) {
                                console.log(response.data);
                                setupEditModal(response.data.CheckoutPayment);
                            })
                            .catch(function (error) { })
                            .finally(function () { });
                    },
    ...
    var setupEditModal = (checkoutpayment) => {

        console.log("pppp", checkoutpayment)
        form.min_range.value = checkoutpayment.min_range;
        form.max_range.value = checkoutpayment.max_range;
        form.payment_percentage.value = checkoutpayment.payment_percentage;

        form.status.value = checkoutpayment.status;
        form._method.value = "PUT";
        document.getElementById("category-modal-title").innerText =
            "Edit Checkout Payment";
        document.getElementById("btn-text").innerHTML = "Update";
        form.action = BASE_URL + "/checkoutpayments/" + checkoutpayment.id;
        alert(88)
        modal.show();
    };
    ...
    document
        .getElementById("category-modal-button")
        .addEventListener("click", function () {
            ...
            form.querySelector("#category_submit").classList.remove(
                "btn-warning"
            );
            form.setAttribute("action", BASE_URL + "/checkoutpayments");
            modal.show();
        });
