...
var KTDatatablesServerSide = (function () {
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                const roleName = parent.querySelectorAll("td")[2].innerText;
                Swal.fire({
                    text:
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    text:
                        "Are you sure you want to Edit this " + roleName + "?",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    showLoaderOnConfirm: true,
                    ...
                    preConfirm: () => {
                        return axios
                            .get(BASE_URL + "/roles/" + id + "/edit")
                            .then(function (response) {
                                console.log(response.data);
                                setupEditModal(response.data.role);
                            })
                            .catch(function (error) {})
                            .finally(function () {});
                    },
    ...
    var setupEditModal = (role) => {
        form.user_type_id.value = role.user_type_id;
        form.value.value = role.value;
        form.status.value = role.status;
        ...
        form.action = BASE_URL + "/roles/" + role.id;
        modal.show();
    };

    (i = document.querySelector("#RoleModal")) &&
        (modal = new bootstrap.Modal(i)),
        (form = document.querySelector("#roleForm")),
        (submitBtn = document.getElementById("role_submit")),
        (cancelBtn = document.getElementById("role_cancel")),
