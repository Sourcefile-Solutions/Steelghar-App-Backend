...
var KTDatatablesServerSide = (function () {
        ...
        deleteButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios
                            .delete(BASE_URL + "/tmt-details/" + id)
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios
                            .get(BASE_URL + "/tmt-details/" + id + "/edit")
                            .then(function (response) {
                                console.log(response.data);
                                setupEditModal(response.data.tmtdetail);
                            })
                            .catch(function (error) { })
                            .finally(function () { });
                    },
    ...
    var setupEditModal = (tmtdetail) => {
        form.thickness.value = tmtdetail.thickness;
        form.weight.value = tmtdetail.weight;
        form.status.value = tmtdetail.status;
        ...
        form.action = BASE_URL + "/tmt-details/" + tmtdetail.id;
        modal.show();
    };
        ...
        (validation = FormValidation.formValidation(form, {
            fields: {
                thickness: {
                    validators: {
                        notEmpty: {
                            message: "thickness field is required",
                        },
                    },
                },
            },
    ...
    document.getElementById('category-modal-button').addEventListener('click', function () {
        ...
        form.setAttribute("action", BASE_URL + '/tmt-details');
        modal.show()
    });
