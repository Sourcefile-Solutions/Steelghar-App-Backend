    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <!--end::Page title-->
                <button id="addbtn" type="button" class="btn btn-primary text-end">Add New Banner</button>
            </div>
...
@section('modals')
    <div class="modal fade" tabindex="-1" id="BannerModal">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="" enctype="multipart/form-data" id="bannerForm">
                    @method('post')
                    @csrf
                    <div class="mb-5 text-center">
                        <h1 class="mb-3" id="banner-modal-title">Banners</h1>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    <span class="required">Mobile Banner</span>
                                </label>
                                <div class="image-input image-input-empty" data-kt-image-input="true" id="mob_banner_img"
                                    style="background-image: url('console/assets/media/svg/files/blank-image.svg')">
                                    <div class="image-input-wrapper stock-image w-175px h-125px"></div>
                                    <label
                                        class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                        ...
                                        title="Add Logo Image">
                                        <i class="bi bi-pencil-fill fs-7"></i>
                                        <input type="file" name="mobile_banner" accept=".png, .jpg, .jpeg" />
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                                    ...
                                    <input type="text" name="banner_name" class="form-control mb-2"
                                        placeholder="Banner Name" value="" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            id="banner_cancel">Close</button>
                        <button type="submit" class="btn btn-primary" id="banner_submit"><span class="indicator-label"
                                id="btn-text">
                                Submit
                            </span></button>
                    </div>
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/banner/index.js') }}"></script>
@endsection
