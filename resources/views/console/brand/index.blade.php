    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <!--end::Page title-->
                <button type="button" class="btn btn-primary text-end" id="brand-modal-button">Add New Brand</button>
            </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="brand-modal-title">Add Brands</h1>
                    <!--begin::Close-->
                ...
                <form class="form" method="POST" action="" enctype="multipart/form-data" id="brandForm">
                    @method('post')
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                                    <label class="required form-label">Price<small>(Per Kg)</small></label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            id="brand_cancel">Close</button>
                        <button type="submit" class="btn btn-primary" id="brand_submit"><span class="indicator-label"
                                id="btn-text">
                                Submit
                            </span></button>
                    </div>
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/brand/index.js') }}"></script>
@endsection
