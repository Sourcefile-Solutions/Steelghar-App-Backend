    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <!--end::Page title-->
                <button type="button" class="btn btn-primary text-end" id="category-modal-button">Add New Category</button>
            </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="category-modal-title">Add Category</h1>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="image-input image-input-empty" data-kt-image-input="true" id="category_img"
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/category/index.js') }}"></script>
@endsection
