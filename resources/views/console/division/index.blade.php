        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <button type="button" class="btn btn-primary text-end" data-bs-toggle="modal"
                    data-bs-target="#DivisionModal">Add New Divisions</button>
            </div>
...
@section('modals')
    <div class="modal fade" tabindex="-1" id="DivisionModal">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="" enctype="multipart/form-data" id="divisionForm">
                    @method('post')
                    @csrf
                    <div class="mb-5 text-center">
                        <h1 class="mb-3" id="division-modal-title">Divisions</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    <span class="required">Division Image</span>
                                </label>
                                <div class="image-input image-input-empty" data-kt-image-input="true" id="division_img"
                                    ...
                                    <label
                                        ...
                                        <input type="file" name="division_image" accept=".png, .jpg, .jpeg" />
                                    </label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            id="division_cancel">Close</button>
                        <button type="submit" class="btn btn-primary" id="division_submit"><span
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/division/index.js') }}"></script>
@endsection
