            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <div class="flex-column-fluid page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Expert Advice</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush mt-6 mt-xl-12">
                    <div class="card-header mt-5">
                        <div class="card-title flex-column">
                            <h3 class="fw-bold mb-1">Expert Advice</h3>
                        </div>
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/expertadvice/index.js') }}"></script>
@endsection
