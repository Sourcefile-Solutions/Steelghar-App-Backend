    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div id="productForm">
                    <form action="{{ route('console.edit-other-product', ['product' => $product->id]) }}" method="post"
                        id="product-form">
                        @csrf
                        <div class="card mt-5 ">
                                    ...
                                    <div id="formArea">
                                        ...
                                        @foreach ($attributes as $index => $item)
                                            <div class="form-group mb-4 row  aaaa">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text"
                                                        name="product_attributes[{{ $index }}][thickness]"
                                                        value="{{ $item->thickness }}" class="form-control mb-2 mb-md-0"
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text"
                                                        name="product_attributes[{{ $index }}][weight]"
                                                        value="{{ $item->weight }}" class="form-control mb-2 mb-md-0"
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" name="kg" class="form-control mb-2 mb-md-0"
                                                        placeholder="Enter Pric/Kg"
                                                        value="{{ $categoryPrice + $item->price }}" disabled />
                                                </div>
                                        ...
                                        <div class="form-group row mb-4  d-none aaaa" id="repeteForm">
                                            ...
                                            <div class="col-md-2">
                                                <label class="form-label">Pric/Kg</label>
                                                <input type="text" name="kg" class="form-control mb-2 mb-md-0"
                                                    placeholder="Enter Pric/Kg" value="{{ $categoryPrice }}" disabled />
                                            </div>
...
@section('scripts')
    <script>
        ...
        function cloneForm() {
            ...
            a.querySelector('input[name="thickness"').name = 'product_attributes[' + document.querySelectorAll('.aaaa')
                .length + '][thickness]';

            a.querySelector('input[name="weight"').name = 'product_attributes[' + document.querySelectorAll('.aaaa')
                .length + '][weight]';
