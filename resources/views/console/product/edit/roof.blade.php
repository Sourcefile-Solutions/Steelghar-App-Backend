    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div id="productForm">
                    <form action="{{ route('console.edit-roof-product', ['product' => $product->id]) }}" method="post"
                        id="product-form">
                        @csrf
                        <div class="card mt-5 ">
                                        ...
                                        @foreach ($attributes as $index => $item)
                                            <div class="form-group mb-4 row  aaaa">
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="product_attributes[{{ $index }}][thickness]"
                                                        class="form-control mb-2 mb-md-0">
                                                        <option value="">Select Thickness</option>
                                                        @foreach ($roofThickness as $thickness)
                                                            <option value="{{ $thickness->id }}"
                                                                {{ $item->thickness == $thickness->id ? 'selected' : '' }}>
                                                                {{ $thickness->thickness }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="kg" class="form-control mb-2 mb-md-0"
                                                        placeholder="Enter Pric/Kg" value="{{ $roofPrice + $item->price }}"
                                                        disabled />
                                                </div>
...
@section('scripts')
    <script>
        ...
        function price(e) {
            ...
            if (isFinite(e.value)) {
                var newPrice = Number(roofPrice) + Number(e.value);
            } else {
                var newPrice = roofPrice;
            }
        ...
        function cloneForm() {
            ...
            a.querySelector('select[name="thickness"').name = 'product_attributes[' + document.querySelectorAll('.aaaa')
                .length + '][thickness]';
