            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <div class="flex-column-fluid page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Roofing Color</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title-->
                <button type="button" class="btn btn-primary text-end" id="category-modal-button">Add New Roofing
                    Color</button>
            </div>
                ...
                <div class="card card-flush mt-6 mt-xl-12">
                    <div class="card-header mt-5">
                        <div class="card-title flex-column">
                            <h3 class="fw-bold mb-1">Roofing Color</h3>
                        </div>
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/roofing-color/index.js') }}"></script>
@endsection
