            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <div class="flex-column-fluid page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Roofing</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title-->
                <a href="{{ route('roofing.create') }}" class="btn fw-bold btn-dark" id="addNewPincode">Add New
                    Roofing</a>
            </div>
                ...
                <div class="card card-flush h-xl-100 mt-5">
                    <div class="card-header pt-7">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Roofing</span>
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/roofing/index.js') }}"></script>
@endsection
