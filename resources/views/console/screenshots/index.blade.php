            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <div class="flex-column-fluid page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Screenshots</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <button type="button" class="btn btn-primary text-end" data-bs-toggle="modal"
                    data-bs-target="#ScreenshotModal">Add New Screenshot</button>
            </div>
                ...
                <div class="card card-flush mt-6 mt-xl-12">
                    <div class="card-header mt-5">
                        <div class="card-title flex-column">
                            <h3 class="fw-bold mb-1">Screenshots</h3>
                        </div>
...
@section('modals')
    <div class="modal fade" tabindex="-1" id="ScreenshotModal">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Screenshots</h5>
                ...
                <form class="form" method="POST" action="" enctype="multipart/form-data" id="screenshotForm">
                    @method('post')
                    @csrf
                    <div class="mb-5 text-center">
                        <h1 class="mb-3" id="screenshot-modal-title">Screenshots</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    <span class="required">Screenshot Image</span>
                                </label>
                                <div class="image-input image-input-empty" data-kt-image-input="true" id="screenshot_img"
                                    ...
                                    <label
                                        ...
                                        <input type="file" name="screenshot_image" accept=".png, .jpg, .jpeg" />
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                                    <label class="required form-label">Screenshot Name</label>
                                    <input type="text" name="screenshot_name" class="form-control mb-2"
                                        placeholder="Screenshot Name" value="" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            id="screenshot_cancel">Close</button>
                        <button type="submit" class="btn btn-primary" id="screenshot_submit"><span
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/screenshot/index.js') }}"></script>
@endsection
