    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <!--end::Page title-->
                <button type="button" class="btn btn-primary text-end" id="subcategory-modal-button">Add New
                    Subcategory</button>
            </div>
...
@section('modals')
    <div class="modal fade" tabindex="-1" id="SubcategoryModal">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="subcategory-modal-title">Add Subcategory</h1>
                ...
                <form class="form" method="POST" action="" enctype="multipart/form-data" id="subcategoryForm">
                    @method('post')
                    @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                                    ...
                                    <input type="text" name="subcategory_name" class="form-control mb-2"
                                        placeholder="Subcategory Name" value="" />
                                </div>
                            </div>
                            <div class="col-md-6 fv-row">
                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                    <span class="required">Subcategory Image</span>
                                </label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                            id="subcategory_cancel">Close</button>
                        <button type="submit" class="btn btn-primary" id="subcategory_submit"><span
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/sub-category/index.js') }}"></script>
@endsection
