            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex"><a class="menu-link"
                ...
                <div class="flex-column-fluid page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">TMT Details</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                <!--end::Page title-->
                <button type="button" class="btn btn-primary text-end" id="category-modal-button">Add New TMT
                    Detail</button>
            </div>
                ...
                <div class="card card-flush mt-6 mt-xl-12">
                    <div class="card-header mt-5">
                        <div class="card-title flex-column">
                            <h3 class="fw-bold mb-1">TMT Details</h3>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title" id="category-modal-title">TMT Details</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-5 fv-row">
                                    ...
                                    <input type="text" name="thickness" class="form-control mb-2" placeholder="Thickness"
                                        value="" />
                                </div>
                            </div>
                            <div class="col-md-6">
...
@section('scripts')
    <script src="{{ asset('console/assets/steelghar/tmtdetail/index.js') }}"></script>
@endsection
