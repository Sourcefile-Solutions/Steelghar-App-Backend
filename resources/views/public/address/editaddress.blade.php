                    ...
                    <div class="col-12 col-lg-9 mt-4 mt-lg-0">
                        <div class="card">
                            ...
                            <div class="card-body card-body--padding--2">
                                <form action="{{ route('update-address', [$address->id]) }}" method="POST" id="address-form">
                                    @csrf
                                    ...
                                    <div class="col-12 col-lg-12 col-xl-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" name="phone"
                                                    placeholder="Your Mobile" value="{{ $address->phone }}" />
                                                @error('phone')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group  col-md-6">
                                                <label for="address-email">Landmark</label>
                                        ...
                                        <div class="form-group mb-0 pt-3 mt-3">
                                            <button class="btn btn-primary" type="submit" id="submit-address">Update
                                                Address</button>
                                        </div>
