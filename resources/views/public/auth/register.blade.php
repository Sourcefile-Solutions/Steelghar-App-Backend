                ...
                <div class="post-view__body">
                    <div class="post-view__item post-view__item-post pt-5">
                        <div class="post-view__card">
                            ...
                            <p class="text-center font-weight-bold" style="font-size: 12px">By Signing up, I agree to the
                                SteelGhar Privacy
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <div class="phone-input-container">
                                                <div class="country-code">Name</div>
                                                <input type="text" id="name" class="phone-input"
                                                    placeholder="Enter Full Name">
                                            </div>
                                            <div class="text-danger ml-5" id="name-error"></div>
                                        </div>
                                        <div class="form-group">
                                            <div class="phone-input-container">
                                                <div class="country-code" style="padding-left: 26px;">+91</div>
                                        ...
                                        <div class="form-group" id="otpDiv">
                                            <div class="phone-input-container">
                                                <div class="country-code" style="padding-left: 26px;">
                                                    OTP</div>
                                        ...
                                        <p class="form-text text-muted text-center mb-0"><a
                                                href={{ route('login') }}>Existing User ? Login</a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        $("#otpDiv").hide(), $("#phone").on("keyup", function() {
            ...
            return (r.preventDefault(), t) ? function e() {
                ...
                let r = $("#phone").val(),
                    n = $("#name").val(),
                    s = !1;
                if (n || (s = !0, $("#name-error").text("Please Enter your Name")), r ? e.test(r) ||
                    (s = !0, $("#phone-error").text("Invalid Phone number")) : (s = !0, $(
                        "#phone-error").text("Please Enter your phone number")), s) return $(
                    "#submitbutton").text("Submit"), $("#submitbutton").prop("disabled", !
                    1), !1;
                $.ajax({
                    type: "POST",
                    headers: {
                    ...
                    success: function(e) {
                        "success" == e.status ? (t = !0, $("#otpDiv").show(), $(
                                "#phone").prop("disabled", !0), $("#name").prop(
                                "disabled", !0), $("#submitbutton").text(
                                "Verify Otp")) : (t = !1, $("#otpDiv").hide(), $(
                                "#phone").prop("disabled", !1), $("#name").prop(
                                "disabled", !1), alert(e.message), $(
