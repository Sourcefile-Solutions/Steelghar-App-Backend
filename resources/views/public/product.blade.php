                        ...
                        <div class="sidebar sidebar--offcanvas--mobile">
                            ...
                            <div class="sidebar__body">
                                ...
                                <div class="sidebar__content">
                                                        ...
                                                        <div class="filter__container">
                                                            <div class="filter-categories">
                                                                <ul class="filter-categories__list">
                                                                    ...
                                                                    <li
                                                                        class="filter-categories__item filter-categories__item--child">
                                                                        <a href="#">Roofing Sheets & Accessories</a>
                                                                        <div class="filter-categories__counter">
                                                                            4
                                                                        </div>
                                                                    </li>
                                                            ...
                                                            <div class="filter-list">
                                                                <div class="filter-list__list">
                                                                    <label class="filter-list__item"><span
                                                                            ...
                                                                            class="filter-list__title">A-One Gold
                                                                        </span><span
                                                                    ...
                                                                    <label class="filter-list__item"><span
                                                                            ...
                                                                            class="filter-list__title">APL Apollo
                                                                        </span><span
                                                                    ...
                                                                    <label
                                                                        class="filter-list__item filter-list__item--disabled"><span
                                                                            ...
                                                                            class="filter-list__title">Gopala
                                                                            TMT</span></label>
                                                                    <label
                                                                        class="filter-list__item filter-list__item--disabled"><span
                                                                            class="input-check filter-list__input"><span
                                                                            ...
                                                                            class="filter-list__title">Prime
                                                                            Gold</span></label>
                                                                    <label class="filter-list__item"><span
                                                                            class="input-check filter-list__input"><span
                                                                                class="input-check__body"><input
                                                                            ...
                                                                            class="filter-list__title">SAIL </span><span
                                                                    ...
                                                                    <label class="filter-list__item"><span
                                                                            ...
                                                                            class="filter-list__title">Surya Prakash
                                                                        </span><span
                                                                            class="filter-list__counter">10</span></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <!--                        src="images/Category/tmt.jpg" alt="" /></a>-->
                                    <!--            </div>-->
                                    <!--            <div class="widget-products__info">-->
                                    <!--                <div class="widget-products__name">-->
                                    <!--                    <a href="#">8MM TMT BARS</a>-->
                                    <!--                </div>-->
                                    ...
                                    <!--            <div class="widget-products__image image image--type--product">-->
                                    <!--                <a href="#" class="image__body"><img class="image__tag"-->
                                    <!--                        src="images/Category/bars.jpg" alt="" /></a>-->
                                    <!--            </div>-->
                                    <!--            <div class="widget-products__info">-->
                                    <!--                <div class="widget-products__name">-->
                                    <!--                    <a href="/productdetails">7MM ROLLING BAR</a>-->
                                    <!--                </div>-->
                                    <!--                <div class="widget-products__prices">-->
                                    <!--                    <div-->
                                    <!--                        class="widget-products__price widget-products__price--current">-->
                                    ...
                                    <!--            <div class="widget-products__image image image--type--product">-->
                                    <!--                <a href="#" class="image__body"><img class="image__tag"-->
                                    <!--                        src="images/Category/14mm-ms-round-bar.jpg"-->
                                    <!--                        alt="" /></a>-->
                                    <!--            </div>-->
                                    <!--            <div class="widget-products__info">-->
                                    <!--                <div class="widget-products__name">-->
                                    <!--                    <a href="#">12MM MS ROUNDS</a>-->
                                    <!--                </div>-->
                                    <!--                <div class="widget-products__prices">-->
                                    ...
                                    <!--            <div class="widget-products__image image image--type--product">-->
                                    <!--                <a href="#" class="image__body"><img class="image__tag"-->
                                    <!--                        src="images/Category/ms-squares.jpg" alt="" /></a>-->
                                    <!--            </div>-->
                                    <!--            <div class="widget-products__info">-->
                                    <!--                <div class="widget-products__name">-->
                                    <!--                    <a href="#">16MM MS SQUARES</a>-->
                                    <!--                </div>-->
                                    <!--                <div class="widget-products__prices">-->
                                    <!--                    <div-->
                                    <!--                        class="widget-products__price widget-products__price--current">-->
                                    ...
                                    <!--            <div class="widget-products__image image image--type--product">-->
                                    <!--                <a href="#" class="image__body"><img class="image__tag"-->
                                    <!--                        src="images/Category/sheets.jpg" alt="" /></a>-->
                                    <!--            </div>-->
                                    <!--            <div class="widget-products__info">-->
                                    <!--                <div class="widget-products__name">-->
                                    <!--                    <a href="#">CR Sheets</a>-->
                                                    ...
                                                    <div class="d-flex pr-2 pt-3 pl-2">
                                                        ...
                                                        <div class="select">
                                                            <select name="format" id="format">
                                                                <option selected disabled class="text-white">Choose a Brand
                                                                </option>
                                                                <option value="pdf">A-One Gold</option>
                                                                <option value="txt">APL Apollo</option>
                                                                <option value="epub">Gopala TMT</option>
                                                                <option value="fb2">Prime Gold</option>
                                                                <option value="mobi">SAIL</option>
                                                                <option value="mobi">Surya Prakash</option>
                                                                <option value="mobi">Tata Steel</option>
                                                                <option value="mobi">Tata Structura</option>
                                                                <option value="mobi">Vizag</option>
                                            ...
                                            <div class="product-card">
                                                <div class="product-card__actions-list">
                                                    {{-- <button class="product-card__action product-card__action--quickview"
                                                        ...
                                                        <svg width="16" height="16">
                                                            <path
                                                                d="M14,15h-4v-2h3v-3h2v4C15,14.6,14.6,15,14,15z M13,3h-3V1h4c0.6,0,1,0.4,1,1v4h-2V3z M6,3H3v3H1V2c0-0.6,0.4-1,1-1h4V3zM3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z" />
                                                        </svg>
                                                    </button> --}}
                                                    <button class="product-card__action product-card__action--wishlist"
                                                        type="button" aria-label="Add to wish list">
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__image">
                                                    <div class="image image--type--product">
                                                        <a href="#" class="image__body"><img class="image__tag"
                                                                src="images/Category/ms-flat.jpg" alt="" /></a>
                                                    </div>
                                                    {{-- <div
                                                        class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                        <div class="status-badge__body">
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__image">
                                                    <div class="image image--type--product">
                                                        <a href="#" class="image__body"><img class="image__tag"
                                                                src="images/Category/download.jpeg" alt="" /></a>
                                                    </div>
                                                    {{-- <div
                                                        class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                        <div class="status-badge__body">
                                                ...
                                                <div class="product-card__info">
                                                    ...
                                                    <div class="product-card__name">
                                                        <div>
                                                            ...
                                                            <a href="#">72X72X1.6MM Square Pipes</a>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex pr-2 pt-3 pl-2">
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__image">
                                                    <div class="image image--type--product">
                                                        <a href="#" class="image__body"><img class="image__tag"
                                                                src="images/Category/Chequeredsheets.jpg"
                                                                alt="" /></a>
                                                    </div>
                                                    {{-- <div
                                                        class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                        ...
                                        <div class="products-list__item">
                                            <div class="product-card">
                                                ...
                                                <div class="product-card__image">
                                                    <div class="image image--type--product">
                                                        <a href="#" class="image__body"><img class="image__tag"
                                                                src="images/Category/black-binding-wire.jpg"
                                                                alt="" /></a>
                                                    </div>
                                                    {{-- <div
                                                        class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
