    ...
    <div class="product-card__info px-2">
        ...
        <div class="form-row pt-3 pl-1 pr-1">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="size" value="1" class="form-control" placeholder="Size" disabled>
            </div>

            <div class="form-group col-md-6">
                <small class="font-weight-bold ">No.of Sheets</small>
                <input type="text" name="no_of_sheet" value="1" class="form-control" placeholder="No of sheets"
                    disabled>
            </div>
        </div>
...
<script>
    var roofThickness = document.querySelectorAll('.roofThickness');


    function roofCalculation(e) {
        // 
        var productCard = e.target.closest('.product-card');
        var thickness = productCard.querySelector(
    ...
    roofThickness.forEach(element => {
        element.addEventListener('change', function(e) {
            ...
            var sizeInput = productCard.querySelector('[name="size"]');
            sizeInput.value = 1;
            sizeInput.disabled = false;
            sizeInput.addEventListener('keyup', roofCalculation);
            var sheetInput = productCard.querySelector('[name="no_of_sheet"]');
            sheetInput.value = 1;
